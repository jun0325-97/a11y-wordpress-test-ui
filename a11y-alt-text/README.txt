...
**A11Y.so**는 SEO가 아닌 접근성에 집중한 이미지 대체 텍스트 자동 생성 플러그인입니다.
...
의도적으로 제외했습니다. A11Y.so는 검색엔진 최적화가 아닌 실제 접근성을 목적으로 합니다. alt 텍스트에 키워드를 억지로 삽입하는 것은 오히려 스크린 리더 사용자 경험을 해칩니다.
