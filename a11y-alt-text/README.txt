...
A11Y automatically generates alt text for your images.
...
* Improved: Clearer error message when API key verification fails due to connectivity issues
...
= 1.10.4 - 2025-07-17 =
* Added: You can now choose regional variants for English (American/British) and Portuguese (Brazil/Portugal). Visit Settings → A11Y to select your preferred variant.
...
= 1.10.0 - 2025-06-06 =
* Added: Configurable admin menu capability - Site admins can now control which user roles can access the A11Y admin menu
